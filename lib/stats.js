...
exports.calc = exports.relativeInfluence = exports.sta = exports.def = exports.atk = exports.cp = exports.cpMultiplier = exports.powerQuotient = exports.stardustToLevel = exports.candyToLevel = exports.levelByCp = exports.cpByLevel = undefined;
...
var atk = exports.atk = function atk(pokemon) {
  return pokemon.individual_attack || 0;
};
var def = exports.def = function def(pokemon) {
  return pokemon.individual_defense || 0;
};
var sta = exports.sta = function sta(pokemon) {
  return pokemon.individual_stamina || 0;
};
...
var calc = exports.calc = function calc(pokemon, _level) {
  ...
  var attack = BaseAttack + atk(pokemon);
  var defense = BaseDefense + def(pokemon);
  var stamina = BaseStamina + sta(pokemon);
